...
**第三个问题，** 对拒答任务，BCE 还是 FlagEmbedding ?
    ...
    之前的配置改用 bge-v1.5-large

    2024-06-18 11:15:15.196 | INFO     | huixiangdou.service.feature_store:analyze:335 - document token histgram count 4760, avg 600.81, median 620
    0-961  97.02%
    961-1922  2.92%
    1922-2883  0.04%
    2883-3844  0.00%
    ...
    在我们的数据上，tokenizer 压缩率更低一些，这个压缩率影响最大输入长度，和精度未必相关。

    长度改 1240

    2024-06-18 11:34:45.685 | INFO     | huixiangdou.service.feature_store:analyze:334 - document text histgram count 5733, avg 1020.57, median 1170
    0-1559  99.95%
    1559-3118  0.00%
    3118-4677  0.03%
    4677-6236  0.00%
    ...
    2024-06-18 11:34:45.687 | INFO     | huixiangdou.service.feature_store:analyze:335 - document token histgram count 5733, avg 499.73, median 512
    0-961  99.67%
    961-1922  0.28%
    1922-2883  0.03%
    2883-3844  0.00%
