...
async def integrate_lark(request: Request, response: Response, body: IntegrateLarkBody,
...
async def integrate_web_search(request: Request, response: Response, body: IntegrateWebSearchBody,
                               hxd_info: QalibInfo = Depends(check_hxd_token)):
    return await QaLibService(request, response, hxd_info).integrate_web_search(body)
