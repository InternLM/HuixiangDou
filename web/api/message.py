...
async def on_wechat_message(request: Request, response: Response, suffix: str, body: WechatRequest):
    return await MessageService(request, response).on_wechat_message(body, suffix)
