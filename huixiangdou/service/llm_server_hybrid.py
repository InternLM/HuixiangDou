...
class HybridLLMServer:
    ...
    def call_alles_apin(self, prompt:str, history: list):
        ...
        headers = {"content-type": "application/json", "alles-apin-token": self.server_config['remote_api_key']}
    ...
    def generate_response(self, prompt, history=[], remote=False):
        ...
        if remote:
            ...
            if llm_type == 'kimi':
                ...
                output_text = self.call_alles_apin(prompt=prompt, history=history)
            else:
