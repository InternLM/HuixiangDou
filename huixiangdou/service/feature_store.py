...
class FeatureStore:
    ...
    def __init__(self,
        ...
        logger.warning(
            '!!! If your feature generated by `text2vec-large-chinese` before 20240205, please use `feature_store.model_path="GanymedeNil/text2vec-base-chinese"` in `config.ini`'  # noqa E501
        )
