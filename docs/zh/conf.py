...
project = 'HuixiangDou'
copyright = '2024, HuixiangDou'
author = 'HuixiangDou Authors'
...
htmlhelp_basename = 'huixiangdoudoc'
...
latex_documents = [
    (root_doc, 'huixiangdou.tex', 'HuixiangDou Documentation', author,
     'manual'),
]
...
man_pages = [(root_doc, 'huixiangdou', 'HuixiangDou Documentation', [author],
              1)]
...
texinfo_documents = [
    (root_doc, 'HuixiangDou', 'HuixiangDou Documentation', author,
     'HuixiangDou Authors', 'Professional knowledge assistant based on LLM.',
     'Miscellaneous'),
]
